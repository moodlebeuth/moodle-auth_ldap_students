...
/**
 * Auth plugin "LDAP students" - Settings
 *
...
if ($ADMIN->fulltree) {
    ...
    if (!function_exists('ldap_connect')) {
        $settings->add(new admin_setting_heading('auth_ldap_students_noextension', '',
        ...
        $settings->add(new admin_setting_heading('auth_ldap_students/pluginname', '',
                new lang_string('auth_ldapdescription', 'auth_ldap')));

        // LDAP server settings.
        $settings->add(new admin_setting_heading('auth_ldap_students/ldapserversettings',
                new lang_string('auth_ldap_server_settings', 'auth_ldap'), ''));

        // Host.
        $settings->add(new admin_setting_configtext('auth_ldap_students/host_url',
        ...
        $versions[2] = '2';
        $versions[3] = '3';
        $settings->add(new admin_setting_configselect('auth_ldap_students/ldap_version',
        ...
        $settings->add(new admin_setting_configselect('auth_ldap_students/start_tls',
                new lang_string('start_tls_key', 'auth_ldap'),
                new lang_string('start_tls', 'auth_ldap'), 0 , $yesno));


        // Encoding.
        $settings->add(new admin_setting_configtext('auth_ldap_students/ldapencoding',
        ...
        $settings->add(new admin_setting_configtext('auth_ldap_students/pagesize',
                get_string('pagesize_key', 'auth_ldap'),
                get_string('pagesize', 'auth_ldap'), '250', PARAM_INT));

        // Bind settings.
        $settings->add(new admin_setting_heading('auth_ldap_students/ldapbindsettings',
                new lang_string('auth_ldap_bind_settings', 'auth_ldap'), ''));

        // Store Password in DB.
        $settings->add(new admin_setting_configselect('auth_ldap_students/preventpassindb',
                new lang_string('auth_ldap_preventpassindb_key', 'auth_ldap'),
                new lang_string('auth_ldap_preventpassindb', 'auth_ldap'), 0 , $yesno));

        // User ID.
        $settings->add(new admin_setting_configtext('auth_ldap_students/bind_dn',
                get_string('auth_ldap_bind_dn_key', 'auth_ldap'),
                get_string('auth_ldap_bind_dn', 'auth_ldap'), '', PARAM_RAW_TRIMMED));

        // Password.
        $settings->add(new admin_setting_configpasswordunmask('auth_ldap_students/bind_pw',
                get_string('auth_ldap_bind_pw_key', 'auth_ldap'),
                get_string('auth_ldap_bind_pw', 'auth_ldap'), ''));

        // User Lookup settings.
        $settings->add(new admin_setting_heading('auth_ldap_students/ldapuserlookup',
                new lang_string('auth_ldap_user_settings', 'auth_ldap'), ''));

        // User Type.
        $settings->add(new admin_setting_configselect('auth_ldap_students/user_type',
        ...
        // Contexts.
        $settings->add(new auth_ldap_admin_setting_special_contexts_configtext('auth_ldap_students/contexts',
                get_string('auth_ldap_contexts_key', 'auth_ldap'),
                get_string('auth_ldap_contexts', 'auth_ldap'), '', PARAM_RAW_TRIMMED));

        // Search subcontexts.
        $settings->add(new admin_setting_configselect('auth_ldap_students/search_sub',
        ...
        $settings->add(new admin_setting_configselect('auth_ldap_students/opt_deref',
                new lang_string('auth_ldap_opt_deref_key', 'auth_ldap'),
                new lang_string('auth_ldap_opt_deref', 'auth_ldap'), LDAP_DEREF_NEVER , $optderef));

        // User attribute.
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext('auth_ldap_students/user_attribute',
                get_string('auth_ldap_user_attribute_key', 'auth_ldap'),
                get_string('auth_ldap_user_attribute', 'auth_ldap'), '', PARAM_RAW));

        // Suspended attribute.
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext('auth_ldap_students/suspended_attribute',
                get_string('auth_ldap_suspended_attribute_key', 'auth_ldap'),
                get_string('auth_ldap_suspended_attribute', 'auth_ldap'), '', PARAM_RAW));

        // Member attribute.
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext('auth_ldap_students/memberattribute',
        ...
        $settings->add(new admin_setting_configtext('auth_ldap_students/memberattribute_isdn',
                get_string('auth_ldap_memberattribute_isdn_key', 'auth_ldap'),
                get_string('auth_ldap_memberattribute_isdn', 'auth_ldap'), '', PARAM_RAW));

        // Object class.
        $settings->add(new admin_setting_configtext('auth_ldap_students/objectclass',
        ...
        $settings->add(new admin_setting_heading('auth_ldap_students/ldapforcepasswordchange',
                new lang_string('forcechangepassword', 'auth'), ''));

        // Force Password change.
        $settings->add(new admin_setting_configselect('auth_ldap_students/forcechangepassword',
                new lang_string('forcechangepassword', 'auth'),
                new lang_string('forcechangepasswordfirst_help', 'auth'), 0 , $yesno));

        // Standard Password Change.
        $settings->add(new admin_setting_configselect('auth_ldap_students/stdchangepassword',
        ...
        $settings->add(new admin_setting_configselect('auth_ldap_students/passtype',
                new lang_string('auth_ldap_passtype_key', 'auth_ldap'),
                new lang_string('auth_ldap_passtype', 'auth_ldap'), 'plaintext', $passtype));

        // Password change URL.
        $settings->add(new admin_setting_configtext('auth_ldap_students/changepasswordurl',
        ...
        $settings->add(new admin_setting_heading('auth_ldap_students/passwordexpire',
        ...
        // Add the setting.
        $settings->add(new admin_setting_configselect('auth_ldap_students/expiration',
                new lang_string('auth_ldap_expiration_key', 'auth_ldap'),
                $description, 0 , $expiration));

        // Password Expiration warning.
        $settings->add(new admin_setting_configtext('auth_ldap_students/expiration_warning',
        ...
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext('auth_ldap_students/expireattr',
                get_string('auth_ldap_expireattr_key', 'auth_ldap'),
                get_string('auth_ldap_expireattr_desc', 'auth_ldap'), '', PARAM_RAW));

        // Grace Logins.
        $settings->add(new admin_setting_configselect('auth_ldap_students/gracelogins',
        ...
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext('auth_ldap_students/graceattr',
                get_string('auth_ldap_gracelogin_key', 'auth_ldap'),
                get_string('auth_ldap_graceattr_desc', 'auth_ldap'), '', PARAM_RAW));

        // User Creation.
        $settings->add(new admin_setting_heading('auth_ldap_students/usercreation',
                new lang_string('auth_user_create', 'auth'), ''));

        // Create users externally.
        $settings->add(new admin_setting_configselect('auth_ldap_students/auth_user_create',
        ...
        $settings->add(new admin_setting_configtext('auth_ldap_students/create_context',
        ...
        $settings->add(new admin_setting_heading('auth_ldap_students/systemrolemapping',
        ...
        foreach ($roles as $role) {
            ...
            if (core_text::strlen($role['settingname']) > 100 || !preg_match('/^[a-zA-Z0-9_]+$/', $role['settingname'])) {
                ...
                $a = (object)['rolename' => $role['localname'], 'shortname' => $role['shortname'], 'charlimit' => 93,
                              'link' => $url->out()];
                $settings->add(new admin_setting_heading('auth_ldap_students/role_not_mapped_' . sha1($role['settingname']), '',
                        get_string('cannotmaprole', 'auth_ldap', $a)));
            } else {
                $settings->add(new admin_setting_configtext('auth_ldap_students/' . $role['settingname'],
        ...
        // User Account Sync.
        $settings->add(new admin_setting_heading('auth_ldap_students/syncusers',
        ...
        $deleteopt[AUTH_REMOVEUSER_DELETEWITHGRACEPERIOD] = get_string('auth_remove_deletewithgraceperiod', 'auth_ldap_students');

        $settings->add(new admin_setting_configselect('auth_ldap_students/removeuser',
        ...
        $settings->add(new admin_setting_configtext('auth_ldap_students/removeuser_graceperiod',
                get_string('removeuser_graceperiod', 'auth_ldap_students'),
                get_string('removeuser_graceperiod_desc', 'auth_ldap_students'), 10, PARAM_INT));

        // Create users.
        $settings->add(new admin_setting_configselect('auth_ldap_students/sync_script_createuser_enabled',
                new lang_string('sync_script_createuser_enabled_key', 'auth_ldap_students'),
                new lang_string('sync_script_createuser_enabled', 'auth_ldap_students'), 1, $yesno));

        // Sync Suspension.
        $settings->add(new admin_setting_configselect('auth_ldap_students/sync_suspended',
                new lang_string('auth_sync_suspended_key', 'auth'),
                new lang_string('auth_sync_suspended', 'auth'), 0 , $yesno));

        // NTLM SSO Header.
        $settings->add(new admin_setting_heading('auth_ldap_students/ntlm',
                new lang_string('auth_ntlmsso', 'auth_ldap'), ''));

        // Enable NTLM.
        $settings->add(new admin_setting_configselect('auth_ldap_students/ntlmsso_enabled',
                new lang_string('auth_ntlmsso_enabled_key', 'auth_ldap'),
                new lang_string('auth_ntlmsso_enabled', 'auth_ldap'), 0 , $yesno));

        // Subnet.
        $settings->add(new admin_setting_configtext('auth_ldap_students/ntlmsso_subnet',
        ...
        $settings->add(new admin_setting_configselect('auth_ldap_students/ntlmsso_ie_fastpath',
        ...
        $settings->add(new admin_setting_configselect('auth_ldap_students/ntlmsso_type',
        ...
        $settings->add(new auth_ldap_admin_setting_special_ntlm_configtext('auth_ldap_students/ntlmsso_remoteuserformat',
